...
export default function TaskContainer({
  ...
  return (
    <div
      className={cn(
        `bg-slate-100 rounded-md p-4 shadow-md border-b-2 border-r-2 border-slate-200 backdrop-blur-md backdrop-filter flex flex-row
      laptop:mb-4
    `,
    ...
    >
      ...
      <div className="flex flex-col w-full gap-2">
        <div className="flex justify-between">
          <div className={
            cn("flex flex-col w-full overflow-auto gap-2", variant === "routine" && "flex-row items-center justify-between pr-2")
          }>
            <h1
              className={cn(
