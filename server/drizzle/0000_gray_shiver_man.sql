...
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "routine_tasks_table" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"user_id" uuid NOT NULL,
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "routine_tasks_table" ADD CONSTRAINT "routine_tasks_table_user_id_users_table_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users_table"("id") ON DELETE cascade ON UPDATE cascade;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "routine_tasks_table" ADD CONSTRAINT "routine_tasks_table_routine_id_routine_table_id_fk" FOREIGN KEY ("routine_id") REFERENCES "public"."routine_table"("id") ON DELETE cascade ON UPDATE cascade;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
